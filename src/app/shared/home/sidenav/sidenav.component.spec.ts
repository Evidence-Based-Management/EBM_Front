...
describe('SidenavComponent', () => {
  ...
  it('should have Dashboard and Manage Iterations links', () => {
    ...
    expect(result[0].nativeElement.innerHTML).toBe('Iterations');
    expect(result[1].nativeElement.innerHTML).toBe('Dashboard');
  });
  ...
  it('should have the arribute routerLink /dashboard and /iterations', () => {
    ...
    expect(result[2].attributes.routerLink).toBe('/dashboard');
  });
});
